...
public class RunJets : MonoBehaviour
{
    ...
    void Speak()
    {
        ...
        if (audioSource != null)
        {
            ...
            audioSource.Play();
            FindObjectOfType<DictationUI>()?.OnJetsTTSStarted(inputText);
        }
        else
        {
    ...
    public void SpeakWithJets(string text)
    {
        inputText = text;
        TextToSpeech();
    }

    public void SpeakPhonemes(string phonemeSequence)
    {
        DoInference(phonemeSequence.Trim());
    }
